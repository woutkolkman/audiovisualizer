...
# ACDS 16.1 203 win32 2020.05.22.16:00:18
...
# ----------------------------------------
# If new_ip is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/new_ip.vhd"
fi
