...
module nios_processor_mm_interconnect_0 (
	...
	wire    [4:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> bel_fft_project_0_avalon_master_agent:rp_channel
	...
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> adc_0_adc_slave_agent:cp_valid
	wire  [107:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> adc_0_adc_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // adc_0_adc_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> adc_0_adc_slave_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> adc_0_adc_slave_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> adc_0_adc_slave_agent:cp_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> bel_fft_project_0_control_slave_agent:cp_valid
	wire  [107:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> bel_fft_project_0_control_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // bel_fft_project_0_control_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> bel_fft_project_0_control_slave_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> bel_fft_project_0_control_slave_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> bel_fft_project_0_control_slave_agent:cp_endofpacket
	...
	wire  [107:0] adc_0_adc_slave_agent_rp_data;                                                      // adc_0_adc_slave_agent:rp_data -> router_006:sink_data
	...
	wire          bel_fft_project_0_control_slave_agent_rp_valid;                                     // bel_fft_project_0_control_slave_agent:rp_valid -> router_007:sink_valid
	wire  [107:0] bel_fft_project_0_control_slave_agent_rp_data;                                      // bel_fft_project_0_control_slave_agent:rp_data -> router_007:sink_data
	wire          bel_fft_project_0_control_slave_agent_rp_ready;                                     // router_007:sink_ready -> bel_fft_project_0_control_slave_agent:rp_ready
	wire          bel_fft_project_0_control_slave_agent_rp_startofpacket;                             // bel_fft_project_0_control_slave_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          bel_fft_project_0_control_slave_agent_rp_endofpacket;                               // bel_fft_project_0_control_slave_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          adc_0_adc_slave_agent_rdata_fifo_src_valid;                                         // adc_0_adc_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] adc_0_adc_slave_agent_rdata_fifo_src_data;                                          // adc_0_adc_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          adc_0_adc_slave_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_003:in_0_ready -> adc_0_adc_slave_agent:rdata_fifo_src_ready
	...
	wire          bel_fft_project_0_control_slave_agent_rdata_fifo_src_valid;                         // bel_fft_project_0_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] bel_fft_project_0_control_slave_agent_rdata_fifo_src_data;                          // bel_fft_project_0_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          bel_fft_project_0_control_slave_agent_rdata_fifo_src_ready;                         // avalon_st_adapter_004:in_0_ready -> bel_fft_project_0_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> bel_fft_project_0_control_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> bel_fft_project_0_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // bel_fft_project_0_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> bel_fft_project_0_control_slave_agent:rdata_fifo_sink_error
	...
	nios_processor_mm_interconnect_0_router_006 router_006 (
	...
	nios_processor_mm_interconnect_0_router_006 router_007 (
	...
	nios_processor_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (bel_fft_project_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_processor_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (bel_fft_project_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_processor_mm_interconnect_0_cmd_demux_002 rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_processor_mm_interconnect_0_cmd_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                            //       clk.clk
		.reset              (bel_fft_project_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
