...
module nios_processor_mm_interconnect_1 (
	...
	wire  [95:0] adc_0_adc_slave_agent_rf_source_data;                                               // adc_0_adc_slave_agent:rf_source_data -> adc_0_adc_slave_agent_rsp_fifo:in_data
	...
	wire  [95:0] adc_0_adc_slave_agent_rsp_fifo_out_data;                                            // adc_0_adc_slave_agent_rsp_fifo:out_data -> adc_0_adc_slave_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> adc_0_adc_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                  // adc_0_adc_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [7:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> adc_0_adc_slave_agent:cp_channel
	...
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> bel_fft_project_0_control_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // bel_fft_project_0_control_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [7:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> bel_fft_project_0_control_slave_agent:cp_channel
	...
	wire  [95:0] freqsep_1_s1_agent_rf_source_data;                                                  // freqsep_1_s1_agent:rf_source_data -> freqsep_1_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] freqsep_1_s1_agent_rsp_fifo_out_data;                                               // freqsep_1_s1_agent_rsp_fifo:out_data -> freqsep_1_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> freqsep_1_s1_agent:cp_valid
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> freqsep_1_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // freqsep_1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> freqsep_1_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> freqsep_1_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> freqsep_1_s1_agent:cp_endofpacket
	...
	wire  [95:0] freqsep_2_s1_agent_rf_source_data;                                                  // freqsep_2_s1_agent:rf_source_data -> freqsep_2_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] freqsep_2_s1_agent_rsp_fifo_out_data;                                               // freqsep_2_s1_agent_rsp_fifo:out_data -> freqsep_2_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> freqsep_2_s1_agent:cp_valid
	wire  [94:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> freqsep_2_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // freqsep_2_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> freqsep_2_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> freqsep_2_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> freqsep_2_s1_agent:cp_endofpacket
	...
	wire  [94:0] adc_0_adc_slave_agent_rp_data;                                                      // adc_0_adc_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [94:0] bel_fft_project_0_control_slave_agent_rp_data;                                      // bel_fft_project_0_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire         freqsep_1_s1_agent_rp_valid;                                                        // freqsep_1_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] freqsep_1_s1_agent_rp_data;                                                         // freqsep_1_s1_agent:rp_data -> router_008:sink_data
	wire         freqsep_1_s1_agent_rp_ready;                                                        // router_008:sink_ready -> freqsep_1_s1_agent:rp_ready
	wire         freqsep_1_s1_agent_rp_startofpacket;                                                // freqsep_1_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         freqsep_1_s1_agent_rp_endofpacket;                                                  // freqsep_1_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         freqsep_2_s1_agent_rp_valid;                                                        // freqsep_2_s1_agent:rp_valid -> router_009:sink_valid
	wire  [94:0] freqsep_2_s1_agent_rp_data;                                                         // freqsep_2_s1_agent:rp_data -> router_009:sink_data
	wire         freqsep_2_s1_agent_rp_ready;                                                        // router_009:sink_ready -> freqsep_2_s1_agent:rp_ready
	wire         freqsep_2_s1_agent_rp_startofpacket;                                                // freqsep_2_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         freqsep_2_s1_agent_rp_endofpacket;                                                  // freqsep_2_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         freqsep_1_s1_agent_rdata_fifo_src_valid;                                            // freqsep_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] freqsep_1_s1_agent_rdata_fifo_src_data;                                             // freqsep_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         freqsep_1_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_006:in_0_ready -> freqsep_1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> freqsep_1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> freqsep_1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // freqsep_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> freqsep_1_s1_agent:rdata_fifo_sink_error
	wire         freqsep_2_s1_agent_rdata_fifo_src_valid;                                            // freqsep_2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] freqsep_2_s1_agent_rdata_fifo_src_data;                                             // freqsep_2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         freqsep_2_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_007:in_0_ready -> freqsep_2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> freqsep_2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> freqsep_2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // freqsep_2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> freqsep_2_s1_agent:rdata_fifo_sink_error
	...
	nios_processor_mm_interconnect_1_router_004 router_004 (
	...
	nios_processor_mm_interconnect_1_router_004 router_008 (
	...
	nios_processor_mm_interconnect_1_router_004 router_009 (
	...
	nios_processor_mm_interconnect_1_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (adc_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_processor_mm_interconnect_1_cmd_mux_002 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_processor_mm_interconnect_1_cmd_mux_002 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_processor_mm_interconnect_1_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (adc_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
