...
module nios_processor_mm_interconnect_1 (
	...
	wire   [24:0] adc_0_adc_slave_agent_m0_address;                                                   // adc_0_adc_slave_agent:m0_address -> adc_0_adc_slave_translator:uav_address
	...
	wire  [101:0] adc_0_adc_slave_agent_rf_source_data;                                               // adc_0_adc_slave_agent:rf_source_data -> adc_0_adc_slave_agent_rsp_fifo:in_data
	...
	wire  [101:0] adc_0_adc_slave_agent_rsp_fifo_out_data;                                            // adc_0_adc_slave_agent_rsp_fifo:out_data -> adc_0_adc_slave_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> adc_0_adc_slave_agent:cp_data
	...
	wire   [24:0] bel_fft_project_0_control_slave_agent_m0_address;                                   // bel_fft_project_0_control_slave_agent:m0_address -> bel_fft_project_0_control_slave_translator:uav_address
	...
	wire  [101:0] bel_fft_project_0_control_slave_agent_rf_source_data;                               // bel_fft_project_0_control_slave_agent:rf_source_data -> bel_fft_project_0_control_slave_agent_rsp_fifo:in_data
	...
	wire  [101:0] bel_fft_project_0_control_slave_agent_rsp_fifo_out_data;                            // bel_fft_project_0_control_slave_agent_rsp_fifo:out_data -> bel_fft_project_0_control_slave_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> bel_fft_project_0_control_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // bel_fft_project_0_control_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> bel_fft_project_0_control_slave_agent:cp_channel
	...
	wire  [100:0] adc_0_adc_slave_agent_rp_data;                                                      // adc_0_adc_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [100:0] bel_fft_project_0_control_slave_agent_rp_data;                                      // bel_fft_project_0_control_slave_agent:rp_data -> router_004:sink_data
