...
module nios_processor_mm_interconnect_1 (
	...
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> bel_fft_project_0_control_slave_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // bel_fft_project_0_control_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> bel_fft_project_0_control_slave_agent:cp_channel
	...
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [94:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [94:0] bel_fft_project_0_control_slave_agent_rp_data;                                      // bel_fft_project_0_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [94:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> cmd_mux_006:sink1_data
	...
	wire  [94:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink3_data
	...
	nios_processor_mm_interconnect_1_router_004 router_006 (
	...
	nios_processor_mm_interconnect_1_router_004 router_007 (
	...
	nios_processor_mm_interconnect_1_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_processor_mm_interconnect_1_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
